...
VALUES
  ('h0000001-0000-0000-0000-000000000001', 'b0000001-0000-0000-0000-000000000001', 'الصالة الرئيسية', 'Main Hall'),
  ('h0000001-0000-0000-0000-000000000002', 'b0000001-0000-0000-0000-000000000001', 'صالة العائلات', 'Family Section'),
  ('h0000001-0000-0000-0000-000000000003', 'b0000001-0000-0000-0000-000000000001', 'الجلسات الخارجية', 'Outdoor Terrace'),
  ('h0000002-0000-0000-0000-000000000001', 'b0000002-0000-0000-0000-000000000001', 'القاعة الملكية VIP', 'Royal VIP Suite'),
  ('h0000002-0000-0000-0000-000000000002', 'b0000002-0000-0000-0000-000000000001', 'جلسات النافورة والحديقة', 'Fountain Garden');

-- Tables
INSERT INTO tables (hall_id, number, seats, status, qr_code_value)
VALUES
  ('h0000001-0000-0000-0000-000000000001', '101', 2,  'free',     'qr_101'),
  ('h0000001-0000-0000-0000-000000000001', '102', 4,  'busy',     'qr_102'),
  ('h0000001-0000-0000-0000-000000000001', '103', 4,  'reserved', 'qr_103'),
  ('h0000001-0000-0000-0000-000000000001', '104', 6,  'cleaning', 'qr_104'),
  ('h0000001-0000-0000-0000-000000000001', '105', 8,  'free',     'qr_105'),
  ('h0000001-0000-0000-0000-000000000002', 'F1',  6,  'free',     'qr_F1'),
  ('h0000001-0000-0000-0000-000000000002', 'F2',  4,  'busy',     'qr_F2'),
  ('h0000002-0000-0000-0000-000000000001', 'R-1', 12, 'busy',     'qr_R1'),
  ('h0000002-0000-0000-0000-000000000001', 'R-2', 8,  'free',     'qr_R2'),
  ('h0000002-0000-0000-0000-000000000002', 'G1',  4,  'free',     'qr_G1');
...
VALUES
  ('i0000001-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001',
   'جبنة موزاريلا بلدي', 'Mozzarella Cheese', 45.5, 10.0, 'كيلو', 'kg', 25.0,
   's0000001-0000-0000-0000-000000000001'),

  ('i0000001-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001',
   'لحم بقري مفروم ممتاز', 'Ground Premium Beef', 85.0, 15.0, 'كيلو', 'kg', 35.0,
   's0000001-0000-0000-0000-000000000002'),

  ('i0000001-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001',
   'صدور دجاج متبلة شاورما', 'Marinated Chicken Breast', 120.0, 20.0, 'كيلو', 'kg', 18.0,
   's0000001-0000-0000-0000-000000000002'),

  ('i0000001-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001',
   'طحين أبيض فاخر', 'Premium White Flour', 250.0, 50.0, 'كيلو', 'kg', 3.5,
   's0000001-0000-0000-0000-000000000001'),

  ('i0000001-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001',
   'صلصة طماطم للبيتزا', 'Craft Pizza Tomato Sauce', 60.0, 12.0, 'لتر', 'liter', 8.0,
   's0000001-0000-0000-0000-000000000001'),

  ('i0000001-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001',
   'بطاطس بلجيكية', 'Belgian Fries Potatoes', 150.0, 30.0, 'كيلو', 'kg', 6.0,
   's0000001-0000-0000-0000-000000000001'),

  ('i0000002-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002',
   'أرز بسمتي هندي عنبر', 'Indian Basmati Amber Rice', 500.0, 80.0, 'كيلو', 'kg', 9.0,
   's0000002-0000-0000-0000-000000000001'),

  ('i0000002-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002',
...
VALUES
  ('m0000001-0000-0000-0000-000000000001', 'شريحة جبن إضافية',       'Extra Cheese Slice',      3.5),
  ('m0000001-0000-0000-0000-000000000001', 'شريحة لحم بقري إضافية',  'Extra Beef Patty',        9.0),
  ('m0000001-0000-0000-0000-000000000001', 'مخلل هلابينو حار',        'Spicy Jalapeno',          2.0),
  ('m0000001-0000-0000-0000-000000000002', 'زيادة ثومية دبل',         'Double Garlic Sauce',     1.5),
  ('m0000001-0000-0000-0000-000000000002', 'إضافة جبنة موزاريلا',    'Melted Mozzarella Inside',3.0),
  ('m0000001-0000-0000-0000-000000000003', 'أطراف محشية بالجبن',     'Cheese Stuffed Crust',    6.0),
  ('m0000001-0000-0000-0000-000000000003', 'فطر فريش بري',            'Wild Fresh Mushroom',     4.0),
  ('m0000001-0000-0000-0000-000000000004', 'سوس الجبنة الشيدر',       'Liquid Cheddar Sauce',    3.0),
  ('m0000002-0000-0000-0000-000000000001', 'أرز إضافي',               'Extra Basmati Rice',     10.0),
  ('m0000002-0000-0000-0000-000000000001', 'مكسرات محمصة مشكلة',     'Toasted Nuts',            5.0);

-- Menu Item Ingredients (وصفات الخصم التلقائي)
INSERT INTO menu_item_ingredients (menu_item_id, ingredient_id, quantity_needed)
VALUES
  ('m0000001-0000-0000-0000-000000000001', 'i0000001-0000-0000-0000-000000000002', 0.220),
  ('m0000001-0000-0000-0000-000000000001', 'i0000001-0000-0000-0000-000000000001', 0.040),
  ('m0000001-0000-0000-0000-000000000002', 'i0000001-0000-0000-0000-000000000003', 0.150),
  ('m0000001-0000-0000-0000-000000000002', 'i0000001-0000-0000-0000-000000000006', 0.050),
  ('m0000001-0000-0000-0000-000000000003', 'i0000001-0000-0000-0000-000000000004', 0.180),
  ('m0000001-0000-0000-0000-000000000003', 'i0000001-0000-0000-0000-000000000005', 0.120),
  ('m0000001-0000-0000-0000-000000000003', 'i0000001-0000-0000-0000-000000000001', 0.140),
  ('m0000001-0000-0000-0000-000000000004', 'i0000001-0000-0000-0000-000000000006', 0.220),
  ('m0000002-0000-0000-0000-000000000001', 'i0000002-0000-0000-0000-000000000001', 0.350),
  ('m0000002-0000-0000-0000-000000000001', 'i0000002-0000-0000-0000-000000000002', 0.400);
